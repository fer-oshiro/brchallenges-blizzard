      ...
      >
        <header className="h-screen text-white flex flex-col">
          ...
          <div className="lg:container lg:mx-auto grid grid-cols-1 md:grid-cols-3 grid-flow-row auto-rows-min  gap-y-16 px-8 my-auto md:pt-20 lg:pt-0">
            ...
            <div
              className={
                'row-start-2 col-start-3 lg:col-start-5 lg:col-span-2 hidden md:block justify-self-end  w-60 lg:w-80 min-h-[185px] lg:min-h-[250px] mt-auto' +
                trailer
              }
            >
          ...
          <div className="min-w-fit mt-auto pl-8">
            ...
            <div className="py-16 text-white flex gap-6 md:text-base text-xs">
              ...
              <p>
                ...
                <a className="underline block cursor-pointer">
                  aplicativo móvel
                </a>
              </p>
            </div>
